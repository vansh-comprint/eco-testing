...
export function PayoutView() {
  ...
  return (
    <div className="space-y-8">
      ...
      >
        <div className="p-8 border-r border-b border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/[0.05] transition-colors group bg-ecotribe-primary/5">
        ...
        <div className="p-8 border-r border-b border-slate-200 dark:border-white/10 hover:bg-slate-50 dark:hover:bg-white/[0.05] transition-colors group">
          <div className="flex items-center justify-between mb-4">
      ...
      >
        <h2 className="font-display font-bold text-lg text-slate-900 dark:text-white uppercase tracking-wide">Payout History</h2>
        <select
          value={statusFilter}
          onChange={(e) => setStatusFilter(e.target.value)}
          className="px-4 py-2.5 bg-slate-50 dark:bg-white/[0.02] border border-slate-200 dark:border-white/10 text-slate-900 dark:text-white font-mono text-xs uppercase tracking-widest focus:outline-none focus:border-ecotribe-primary/50 transition-colors appearance-none select-themed cursor-pointer min-w-[150px]"
        >
      ...
      >
        {isLoading ? (
          ...
          filteredPayouts.map((payout: any, index: number) => {
            ...
            return (
              <motion.div
                ...
                className="border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.02] hover:border-slate-300 dark:hover:border-white/20 transition-colors"
              >
                <div className="p-5">
                  <div className="flex items-center gap-5">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-3 mb-1">
                        <h3 className="font-display font-bold text-sm text-slate-900 dark:text-white uppercase tracking-wide">{batchName}</h3>
                    ...
                    <div className="text-right">
                      <p className={`font-brand font-bold text-2xl ${
                        payout.status === 'completed' ? 'text-emerald-400' : 'text-slate-900 dark:text-white'
                      }`}>
          ...
          <div className="border border-slate-200 dark:border-white/10 bg-slate-50 dark:bg-white/[0.02] py-16 text-center">
            ...
            <p className="font-display font-bold text-slate-900 dark:text-white uppercase tracking-wide mb-1">No payouts found</p>
            <p className="font-mono text-xs text-zinc-600">
