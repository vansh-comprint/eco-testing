/**
 * STATUS: COMPLETE
 * Consolidated: super/Settings.tsx (Super Admin settings — profile, password change)
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="border-b border-slate-200 dark:border-white/10 pb-8">
        ...
        >
          <span className="font-mono font-bold text-xs text-ecotribe-primary tracking-[0.3em] uppercase block mb-2">Super Admin</span>
          <h1 className="font-brand font-bold text-3xl md:text-4xl text-slate-900 dark:text-white uppercase tracking-tight">
            Settings
          </h1>
          <p className="font-display text-slate-600 dark:text-zinc-500 text-sm mt-2 uppercase tracking-wide">Manage your account</p>
        </motion.div>
      </div>
