...
export function OrgAdminSimpleDashboard() {
  ...
  const totalPendingValue = pendingApproval.reduce((sum, b) => sum + safeNumber(b.estimated_value), 0);
  const totalApprovedValue = approvedBatches.reduce((sum, b) => sum + safeNumber(b.estimated_value), 0);
      ...
      >
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          <div className="flex items-center gap-3">
            ...
            <span className="font-display font-bold text-sm text-slate-600 dark:text-zinc-400 uppercase tracking-wide">Batches require Org Admin approval when:</span>
          </div>
          <div className="flex items-center gap-4">
