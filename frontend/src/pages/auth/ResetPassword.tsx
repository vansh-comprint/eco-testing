 ...
 * Accessed via /reset-password?token=<token>
 */
          ...
          {isSubmitted ? (
            ...
            >
              ...
              <button
                ...
                className="w-full px-6 py-3 bg-ecotribe-primary text-black font-brand font-bold uppercase text-xs tracking-wider btn-chamfer hover:bg-white transition-colors"
              >
                Go to Login
              </button>
            </motion.div>
