...
interface BackButtonProps {
  /** Explicit route to navigate to (preferred over navigate(-1)) */
  to: string;
  /** Label displayed next to the chevron, e.g. "Back to Branches" */
  label: string;
 ...
 * Always navigates to an explicit route (never navigate(-1)).
 */
