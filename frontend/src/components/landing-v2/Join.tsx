    ...
    <section id="join" className="bg-transparent py-32 md:py-48 relative overflow-hidden transition-colors duration-500">
      <div className="container mx-auto px-6 max-w-[1400px] text-center">
        ...
        <h2 className="font-brand font-bold text-5xl md:text-7xl text-black dark:text-white mb-12">
          Join the <span className="font-brand italic font-normal tracking-tight text-ecotribe-primary">Collective.</span>
        </h2>
        ...
        <div className="mt-16">
          <button
            ...
            className="px-12 py-4 bg-ecotribe-primary text-black font-mono font-bold uppercase tracking-widest hover:bg-white dark:hover:bg-white transition-colors btn-chamfer shadow-lg dark:shadow-none"
          >
            Access Portal
          </button>
        </div>
